...
export const TABLE_SUFFIX = 'ccl_stream_scheduled_recordings' as const

export const scheduledRecordingsTable = cclTable(TABLE_SUFFIX)

const SCHEDULED_RECORDINGS_DDL = new SqliteTableDefinition()
...
export function buildCreateTableSql(qualified: string): string {
  return SCHEDULED_RECORDINGS_DDL.toCreateTableSql(qualified)
}
