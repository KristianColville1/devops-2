...
export const TABLE_SUFFIX = 'ccl_stream_total_business_daily_storage' as const

export const totalBusinessDailyStorageTable = cclTable(TABLE_SUFFIX)

const TOTAL_BUSINESS_DAILY_DDL = new SqliteTableDefinition()
...
export function buildCreateTableSql(qualified: string): string {
  return TOTAL_BUSINESS_DAILY_DDL.toCreateTableSql(qualified)
}
